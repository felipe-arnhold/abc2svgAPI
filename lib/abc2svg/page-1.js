...
var abc2svg={}
abc2svg.page={abc_end:function(of){if(this.cfmt().pageheight){var page=this.page
if(page&&page.in_page)
abc2svg.page.close_page(page)
if(abc2svg.page.user_out){user.img_out=abc2svg.page.user_out
abc2svg.page.user_out=null}}
of()},svg_tag:function(w,h,ty){w=Math.ceil(w)
h=Math.ceil(h)
abc2svg.page.user_out('<svg xmlns="http://www.w3.org/2000/svg" version="1.1"\n\
...
break
case'F':d=typeof document!="undefined"?window.location.href:page.abc.parse.fname
break
case'I':c=str[++i]
s+=c
...
abc2svg.page.user_out(sty+'<g transform="translate(0,'+
page.topmargin.toFixed(1)+')">\n'+
page.hf+'</g>\n</svg>')
page.hmax-=h;page.hf=''}else{abc2svg.page.svg_tag(cfmt.pagewidth,ht,"header")
...
abc2svg.page.user_out(page.ffsty+'<g transform="translate(0,'+
(h-page.fh).toFixed(1)+')">\n'+
page.hf+'</g>\n</svg>')}
...
user.img_out=abc2svg.page.img_in.bind(this);abc2svg.abc_end=abc2svg.page.abc_end.bind(this,abc2svg.abc_end)}
return}
