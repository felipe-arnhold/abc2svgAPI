...
return
var i,si,ei,elt,tunes,C=abc2svg.C
...
ctxMenu.style.display="none";play.playing=true;if(tunes!=abc.tunes){tunes=abc.tunes
for(i=0;i<tunes.length;i++){elt=tunes[i]
