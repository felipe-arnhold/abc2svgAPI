...
var abc2svg={}
function dom_loaded(){var abc,e,new_page,playing,abcplay,tune_dur,scroll_to,dt,sY,page,a_inc={},errtxt='',app="abcweb1",playconf={onend:function(){playing=false}},tune_lst,jsdir=document.currentScript?document.currentScript.src.match(/.*\//):(function(){var s_a=document.getElementsByTagName('script')
...
tune_lst=[]
abc2svg.abc=abc=new abc2svg.Abc(user)
new_page=""
